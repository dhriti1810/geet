...
class View:
    def __init__(self, top=None):
        ...
        self.songName.configure(text='''Add songs...''')
        ...
        self.vol_scale1 = ttk.Scale(top)
        self.vol_scale1.place(relx=0.200, rely=0.932, relwidth=0.146, relheight=0.0
                              , height=26, bordermode='ignore')
        self.vol_scale1.configure(takefocus="")
    ...
    def setup_player(self):
        ...
        self.playList.config(font="Arial 12")
        self.playList.bind("<Double-1>",self.list_double_click)
        self.top.title("MOUZIKKA-Dance To The Rhytm Of Your Heart!")
    ...
    def play_song(self):
        ...
        try:
            ...
            self.vol_scale1.config(from_=0, to=self.song_length, command=self.move_song)
            self.vol_scale1.set(0)
            self.isPaused = False
            self.setup_thread()
    ...
    def move_song(self,val):
        ...
        self.settime=True
        self.my_player.set_posi(self.val)
    ...
    def load_songs_from_favourites(self):
        try:
            ...
            if result.find("No songs in your favourites")!=-1:
    ...
    def remove_song_from_favourites(self):
            ...
            try:
                if len(remove_song_index_tuple) == 0:
                    raise NoSongSelectedError("Please select a song")
                song_name = self.playList.get(remove_song_index_tuple)
